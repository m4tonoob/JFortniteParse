...
const val PakVersion_FrozenIndex = 9                    // UE4.25 - used only in 4.25, removed with 4.26
const val PakVersion_PathHashIndex = 10                 // UE4.26+ - all file paths are encrypted (stored as 64-bit hash values)
const val PakVersion_Fnv64BugFix = 11
const val PakVersion_V12 = 12                           // Fortnite 38.00+ - new format changes
const val PakVersion_Last = 13
const val PakVersion_Latest = PakVersion_V12